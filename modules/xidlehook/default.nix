{ pkgs, ... }: {
  #TODO: betterlock screen problem
  # services.xidlehook = {
  #   enable = true;
  ...
  #     #   delay = 240 + 1200;
  #     #   command = ''
  #     #     ${pkgs.notify-desktop}/bin/notify-desktop --app-name=systemctl --urgency=critical "Sleeping in 1 min"'';
  #     #   canceller = ''
  #     #     ${pkgs.notify-desktop}/bin/notify-desktop --app-name=systemctl "Sleep cancelled"'';
  #     # }
  #     # {
  #     #   delay = 60;
